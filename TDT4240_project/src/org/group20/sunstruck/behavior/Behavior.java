...
public class Behavior {
	public static enum BEHAVIOR {
		LINEAR_MOVEMENT, KAMIKAZE_FOR, KAMIKAZE_VEL, SIN_VEL, SIN_FOR, LINE, SPRAY, PLAYER_GRAVITY, KAMIKAZE_FOR_ANGLE, BOSS_GET_IN_POSITION, BOSS_ATTACK, BOSS_CHARGE, BOSS_LAUNCH
	}
